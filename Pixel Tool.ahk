; ~ MButton:: Serve para ligar o script e mudar de função.
; ~ Alt:: Serve para copiar a cor exibida.

; ~ RButton:: Serve para selecionar uma área.
; ~ End:: Serve para finalizar o script.

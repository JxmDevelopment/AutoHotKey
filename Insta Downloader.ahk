...
ImageSearch, FoundX, FoundY, 0, 0, 2560, 1080, C:\AutoHotkey\Scripts\IMG\link1.png
If ErrorLevel = 0
...
Text := "Numpad1 > IMG Perfil`nNumpad2 > Vid Reels/Perfil`nNumpad4 > IMG Story`nNumpad5 > Vid Story"
